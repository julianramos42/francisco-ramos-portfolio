export default function FeaturesBlocks() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 top-2/4 md:mt-24 lg:mt-0 bg-gray-900 pointer-events-none" aria-hidden="true"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Mis Principios</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 md:max-w-2xl lg:max-w-none">

            {
              items &&
              items.map((item, i) => (
                <div key={i} className="relative flex flex-col items-center p-6 pt-0 bg-white rounded shadow-xl border border-black" data-aos="fade-left">
